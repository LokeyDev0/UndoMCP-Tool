...
After setup, Continue with your workflow like normal and once you want any undo changes made by the AI agent via MCP simply invoke UndoMCP by using the command:
